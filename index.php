...
<head>
    ...
    <title>Duvidas Frequentes Fatec</title>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item mx-auto">
                            <h2 class="navbar-brand text-dark text-center" style="font-size: 20px;">Central de Ajuda</h2>
                        </li>
                        <li class="nav-item ms-auto">
                            <a class="nav-link btn" href="index.php" style="font-size: 17px;">Início</a>
                        </li>
                        <li class="nav-item ms-auto">
                            <a class="nav-link btn" href="enviar_pergunta.html" style="font-size: 17px;">Enviar uma pergunta</a>
                        </li>
                        <li class="nav-item ms-auto">
                            <a class="nav-link btn" href="login.html" style="font-size: 17px;">Área administrativa</a>
                        </li>
                    </ul>
                </div>
            </div>
